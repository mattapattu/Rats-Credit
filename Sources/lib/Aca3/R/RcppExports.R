...
simulateTrials <- function(allpaths, H, alpha, gamma, total_trials, init_state, model, policyMethod, epsilon = 0) {
...
getProbMatrix <- function(allpaths, alpha, gamma, H, sim, model, policyMethod, epsilon = 0) {
    .Call(`_Aca3_getProbMatrix`, allpaths, alpha, gamma, H, sim, model, policyMethod, epsilon)
}
