...
simulateTrials <- function(allpaths, H, alpha, total_trials, init_state, model, policyMethod, epsilon) {
    .Call(`_baseModels_simulateTrials`, allpaths, H, alpha, total_trials, init_state, model, policyMethod, epsilon)
}

getPathLikelihood <- function(allpaths, alpha, H, sim, model, policyMethod, epsilon, endTrial) {
    .Call(`_baseModels_getPathLikelihood`, allpaths, alpha, H, sim, model, policyMethod, epsilon, endTrial)
}

getProbMatrix <- function(allpaths, alpha, H, sim, model, policyMethod, epsilon, endTrial) {
