...
acaTurnData = function(generated_data, turnTimes, sim, half_index, end_index, window){
  ACA = DEoptim(negLogLikFunc, lower = 0, upper = 1, allpaths = generated_data[1:half_index,], turnTimes = turnTimes, model=1, sim=sim, DEoptim.control(NP = 10,F = 0.8, CR = 0.9, trace = FALSE, itermax = 200))
...
gbTurnData = function(generated_data, sim, half_index, end_index, window){
...
aca3TurnData = function(generated_data, turnTimes, sim, half_index, end_index, window){
