...
acaData = function(Hinit2, generated_data, sim, half_index, end_index, window){
  ...
  ACA_probMatrix = baseModels::getProbMatrix(generated_data, alpha_ACA, H=Hinit2, sim, model=1, policyMethod=2, epsilon = epsilon_ACA, endTrial_ACA)
...
gbData = function(Hinit2, generated_data, sim, half_index, end_index, window){
  ...
  GB_probMatrix = baseModels::getProbMatrix(generated_data, alpha_GB, H=Hinit2, sim, model=2, policyMethod=2, epsilon = epsilon_GB, endTrial_GB)
  params_lik = list("alpha"=alpha_GB, "epsilon"=epsilon_GB, "endTrial"=endTrial_GB)
...
aca2Data = function(Hinit2, generated_data, sim, half_index, end_index, window){
  ...
  ACA2_probMatrix = Aca2::getProbMatrix(generated_data, alpha_ACA2, H=Hinit2, sim, model=4, policyMethod=2, epsilon = epsilon_ACA2)
...
aca3Data = function(Hinit2, generated_data, sim, half_index, end_index, window){
  ...
  ACA3_probMatrix = Aca3::getProbMatrix(generated_data, alpha_ACA3,gamma_ACA3, H=Hinit2, sim, model=5, policyMethod=2, epsilon = epsilon_ACA3)
